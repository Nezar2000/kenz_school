...
<body>
    <div class="sidebar">
        <div class="logo_content">
            <div class="logo">
                <a href="stats.php"><i class='bx bxs-school'></i>
...
<div class="home_content">
         ...
         <div class="row align-items-center">
                ...
                <div class="col">
                <div class="card">
                     <img src="png/ele.png"class="card-img-center" alt="...">
                     <div class="card-body">
               ...
               <div class="col">
               <div class="card">
                     <img src="png/profs.png"class="card-img-center" alt="..." >
                     <div class="card-body">
                ...
                <div class="col">
                <div class="card">
                     <img src="png/classroom.png"class="card-img-center" alt="...">
                     <div class="card-body">
