...
<body>
    ...
    <div class="home_content">
        ...
        <div class="row align-items-center">
            <a href="profhome.php" style="text-decoration:none;color:black;"> <i class='bx bx-undo'></i>RETOUR</a>
            <div class="card">
                ...
                ?>
                    <div>Supprimer :<a href="supprimerback.php?file=<?php echo $rows['filename'] ?>"><?= $rows['filename'] ?></a></div><br>
                <?php
                }
                ?>
