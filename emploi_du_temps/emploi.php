...
<div class="home_content">
         ...
         <div class="row align-items-center">
                ...
                <div class="col">
                <div class="card">
                     <img  style="height:150px;width:9.5em;margin-top:10px;" src="png/a.png"class="card-img-center" alt="...">
                     <div class="card-body">
                     <a href="deposer.php" class="btn  btn-primary" >Déposer l'emploi du temps</a>
                     </div>
                </div>
                </div>
               ...
               <div class="col">
               <div class="card">
                     <img  style="height:150px;width:9.5em;margin-top:10px;" src="png/dow.png"class="card-img-center" alt="..." >
                     <div class="card-body">
                     <a href="telecharger.php" class="btn btn-primary">Télécharger l'emploi du temps</a>
                     </div>
                </div>
                </div>
                ...
                <div class="col">
                <div class="card">
                    <img   style="height:150px;width:9.5em;margin-top:10px;" src="png/del.png" class="card-img-center" alt="...">
                    <div class="card-body">
                    <a href="supprimer.php" class="btn btn-primary">Supprimer l'emploi du temps</a>
                    </div>
                </div>
                </div>
