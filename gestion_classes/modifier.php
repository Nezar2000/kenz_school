                                        ...
                                        { ?>
                                            <form action="modifier.php" method="POST" >
                                               ...
                                               <label for="saison_cl"  style="margin-right:10px;font-weight:bold;">Année scolaire:</label><input type="text" name="saison_cl" value="<?php echo $row['saison_cl'] ?>"/><br>
                                                <br><input type="submit" id="mod" name="mod" value="Modifier"><br>
...
if(isset($_POST['mod']))
{
    ...
    $query = "UPDATE `classes` SET nom_cl='$_POST[nom_cl]', niveau_cl='$_POST[niveau_cl]',saison_cl='$_POST[saison_cl]' where id_cl='$_POST[id_cl]'"; 
    $query_run = mysqli_query($con,$query);
