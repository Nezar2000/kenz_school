...
<div class="home_content">
         ...
         <div class="row align-items-center">
                ...
                <div class="col">
                <div class="card">
                     <img  style="height:150px;width:9.5em;margin-top:10px;" src="png/mo.png"class="card-img-center" alt="...">
                     <div class="card-body">
                     <a href="ajouter.php" class="btn  btn-primary" >Ajouter élève</a>
                     </div>
                </div>
                </div>
               ...
               <div class="col">
               <div class="card">
                     <img  style="height:150px;width:9.5em;margin-top:10px;" src="png/aj.png"class="card-img-center" alt="..." >
                     <div class="card-body">
                     <a href="chercher.php" class="btn btn-primary">Modifier élève</a>
                     </div>
                </div>
                </div>
                ...
                <div class="col">
                <div class="card">
                    <img   style="height:150px;width:9.5em;margin-top:10px;" src="png/se.png" class="card-img-center" alt="...">
                    <div class="card-body">
                    <a href="supprimer.php" class="btn btn-primary">Supprimer élève</a>
                    </div>
                </div>
                </div>
